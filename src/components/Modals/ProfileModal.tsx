...
const ProfileModal = ({onClose}: ProfileModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-10 flex justify-center items-center bg-black bg-opacity-30 animate-fade-in">
            <div
                className="relative z-0 h-fit rounded mx-auto bg-white lg:max-w-[400px] w-full max-w-screen-lg animate-zoom-in">
                ...
                <div className="relative w-full h-fit overflow-x-hidden overflow-y-hidden">
                    <SwitchTransition mode="out-in">
                        ...
                        >
                            <div>
                                ...
                                {activeTab === 2 && (
                                    <PreviewChangeAvatarModal onBackTab={onBackTab}
